...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        //__connecterMouseOver/Out change la couleur par défaut : problématique pour le chemin vert
...
//            });
        ...
        _refreshLinkPositions: function (linkId) {
            ...
            var bezierToX = toX + 1;
            var bezierIntensity = Math.min(100, Math.max(Math.abs(bezierFromX - bezierToX), Math.abs(fromY - toY)));
